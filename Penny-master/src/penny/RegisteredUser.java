...
public class RegisteredUser extends User// attributes and constractors
{
  ...
  public void makeMonthlyDonation(int amount, int charityId, String dateOfPayment, String name)
  { 
      Monthly donation = new Monthly(amount, charityId, dateOfPayment, name);
